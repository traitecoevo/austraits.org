...
<section id="access" class="page-band">
  <div class="platform-shell">
    ...
    <div class="explore-grid">
      ...
      <a class="resource-card" href="https://traitecoevo.github.io/traits.build-book/content/AusTraits_tutorial.html" target="_blank" rel="noopener">
  ...
  <div class="platform-shell">
    ...
    <div class="tools-grid">
      ...
      <article class="software-card">
        ...
        <div>
          <h3>APCalign</h3>
          <p>An R package and <a href="apcalign.html">Shiny app</a> for aligning Australian vascular plant names...
